...
interface IOnboardingService_IOnboard
  extends grpc.MethodDefinition<api_pb.BatchOnboarding, api_pb.Responses> {
...
interface IOnboardingService_IOnboardStream
  extends grpc.MethodDefinition<api_pb.BatchOnboarding, api_pb.Responses> {
...
export interface IOnboardingServer extends grpc.UntypedServiceImplementation {
  ...
  onboardStream: grpc.handleBidiStreamingCall<
    api_pb.BatchOnboarding,
    api_pb.Responses
  >;
}
...
export interface IOnboardingClient {
  onboard(
    request: api_pb.BatchOnboarding,
    callback: (
      error: grpc.ServiceError | null,
      response: api_pb.Responses
    ) => void
  ...
  onboardStream(): grpc.ClientDuplexStream<
    api_pb.BatchOnboarding,
    api_pb.Responses
  >;
  onboardStream(
    options: Partial<grpc.CallOptions>
  ): grpc.ClientDuplexStream<api_pb.BatchOnboarding, api_pb.Responses>;
  onboardStream(
    metadata: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientDuplexStream<api_pb.BatchOnboarding, api_pb.Responses>;
