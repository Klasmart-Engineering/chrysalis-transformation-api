import { isSchoolProgramValid, isSchoolValid, checkClassesValid } from "./validationChecks";
...
export async function validateClasses(classes: MappedClass[]): Promise<boolean> {
