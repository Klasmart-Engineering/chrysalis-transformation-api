...
export const organizationSchema = Joi.object({
  OrganizationUUID: Joi.string()
    ...
    .messages({
      'string.base':
        stringInject(messages['string.base'], ['OrganizationUUID']) || '',
      'string.empty':
        stringInject(messages['string.empty'], ['OrganizationUUID']) || '',
      'string.guid':
        stringInject(messages['string.guid'], ['OrganizationUUID']) || '',
    }),
